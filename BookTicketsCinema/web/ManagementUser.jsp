                     ...
                     <div class="row" style="margin-left:600px; margin-top:20px">                        
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 style="font-family: sans-serif;font-weight: bolder">Tổng Số Tài Khoản</h5>
                    ...
                    <div class="ecommerce-widget">
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-left:30px;">
                                <div class="card">
                                    <h5 class="card-header" style="font-family: sans-serif; font-weight: bold">QUẢN LÝ NGƯỜI DÙNG 
                                     <a href="adduser">  <img src="images/add_user_icon.png" width="50px" alt="alt"/></a>                                            </h5>
                                                ...
                                                <tbody>                       
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center">
                                                            <a href="deleteuser?id=${u.id}" ><img src="images/delete.png" width="30px" alt="alt"/></a>
                                                            <a href="updateinfouser?id=${u.id}" ><img src="images/edit-icon.png" width="35px" alt="alt"/>
                                                        </td>
                                                    </tr>
                                                    </c:forEach>
