...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list" style="background-color: #ffffff;overflow: hidden;width: auto;height: 100%; border: #000">
                ...
                <div class="row" style="margin-left:450px; margin-top:100px">
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="card border-3 border-top border-top-primary">
                            <div class="card-body">
                                <h5 class="text-muted">Tổng Số Tài Khoản</h5>
                                <div class="metric-value d-inline-block">
                                    <h1 class="mb-1">${sizeU}</h1>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="card border-3 border-top border-top-primary">
                            <div class="card-body">
                                <h5 class="text-muted">Tổng Số Order</h5>
                                <div class="metric-value d-inline-block">
                                    <h1 class="mb-1">${sizeO}</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ecommerce-widget">
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-left:30px">
                                <div class="card">
                                    <h5 class="card-header" style="font-family: sans-serif; font-weight: bold">ĐƠN BOOK GẦN NHẤT</h5>
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">CHAIRNAME</th>
